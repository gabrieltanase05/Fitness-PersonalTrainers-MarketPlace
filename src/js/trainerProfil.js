                ...
                <section>
                    ...
                    <article className="activityInformation">
                        <form><h1>Activity Information</h1>
                            <hr/>
                            <label>Sport Type: SELECT/EDIT(sports list)</label>
                            <label>Sport Location: SELECT/EDIT(Gym, out dor, else)</label>
                            <label>Food Type: SELECT/EDIT</label>
                            <label>My Goal: SELECT/EDIT</label>
                            <label>Description: EDIT</label>
                            <label>Health and Medical Issues: EDIT</label>
                            <label>Training History: EDIT</label>
                        </form>
                    </article>
                </section>
                :
